...
public class CameraSource {
    ...
    private Camera createCamera() throws IOException {
        ...
        // two for the frames that camera uses to populate future preview images.
        //
     ...
     * camera preview size and format of the camera image.
     *
     * @param previewSize
    ...
    private byte[] createPreviewBuffer(Size previewSize) {
        ...
        if (!byteBuffer.hasArray() || (byteBuffer.array() != byteArray)) {
            // This should never happen. If it does, then we wouldn't be passing the preview to
            // the undelying detector later.
    ...
    private class FrameProcessingRunnable implements Runnable {
        ...
        void setNextFrame(byte[] data, Camera camera) {
            synchronized (lock) {
                ...
                // Notify the processor thread if it is wating on the next frame
                lock.notifyAll();
            }
        }
